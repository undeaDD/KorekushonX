...
class SammlungCompactView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        layout.itemSize = CGSize(width: UIScreen.main.bounds.width / 4.0, height: 165)
...
extension SammlungCompactView: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UISearchResultsUpdating, UIAdaptivePresentationControllerDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setUp(manager.filtered[indexPath.row], books)
        return cell
    }
